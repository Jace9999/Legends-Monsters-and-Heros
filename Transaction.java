...
public class Transaction {
    ...
    public Transaction(Hero hero, Market market,Player player) {
        quitGame = false;
        this.hero = hero;
        this.market = market;
        this.player = player;
            ...
            if (itemName.equals("I")){
                ...
                if(weapon == null && spell == null && armor == null && potion == null){
                    ...
                    if(cost > hero.getGold()){
                        ...
                        market.getInventories().getWeapons().remove(weapon);
                    }
                }else if(spell!=null){
                    ...
                    if(cost > hero.getGold()){
                        ...
                        hero.setGold(hero.getGold() - cost);
                        market.getInventories().getSpells().remove(spell);
                    }
                }else if(armor != null){
                    ...
                    if(cost > hero.getGold()){
                        ...
                        hero.setGold(hero.getGold() - cost);
                        market.getInventories().getArmors().remove(armor);
                    }
                }else{
                    ...
                    if(cost > hero.getGold()){
                        ...
                        hero.setGold(hero.getGold() - cost);
                        market.getInventories().getPotions().remove(potion);
                    }
                }
            }
        }
        ...
        while (true){
            ...
            if (itemName.equals("I")){
                ...
                if(weapon == null && spell == null && armor == null && potion == null){
                    ...
                    hero.setGold(hero.getGold() + cost);
                    market.getInventories().getWeapons().add(weapon);
                }else if(spell!=null){
                    ...
                    hero.setGold(hero.getGold() + cost);
                    market.getInventories().getSpells().add(spell);
                }else if(armor != null){
                    ...
                    hero.setGold(hero.getGold() + cost);
                    market.getInventories().getArmors().add(armor);
                }else{
                    ...
                    hero.setGold(hero.getGold() + cost);
                    market.getInventories().getPotions().add(potion);
                }
            }
        }
    }
